            ...
            <div class="row">
              ...
              <div class="row py-2">
                  <div class="col-sm-12">
                      ...
                      <input class="form-check-input" type="checkbox"  name="hobby[]"  value="Reading" role="switch" id="flexSwitchCheckDefault">
                      <label class="form-check-label" for="flexSwitchCheckDefault">Reading</label>
                      <input class="form-check-input" type="checkbox"  name="hobby[]"  value="Writing" role="switch" id="flexSwitchCheckDefault">
                      <label class="form-check-label" for="flexSwitchCheckDefault">Writing</label>
                      <input class="form-check-input" type="checkbox"  name="hobby[]"  value="Gardning" role="switch" id="flexSwitchCheckDefault">
                      <label class="form-check-label" for="flexSwitchCheckDefault">Gardning</label>
                      <input class="form-check-input" type="checkbox"  name="hobby[]"  value="Cricket" role="switch" id="flexSwitchCheckDefault">
                      <label class="form-check-label" for="flexSwitchCheckDefault">Cricket</label>
                      <input class="form-check-input" type="checkbox"  name="hobby[]"  value="Movies" role="switch" id="flexSwitchCheckDefault">
